...
public class GasussianBlurRenderFeature : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        private const string ProfilerTag = "GaussianBlur";
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            volume = stack.GetComponent<GaussianBlurVolume>();//从栈中获取到ColorTintVolume
