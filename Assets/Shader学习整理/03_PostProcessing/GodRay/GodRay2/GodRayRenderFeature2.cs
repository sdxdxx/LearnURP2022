...
public class GodRayRenderFeature2 : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        private const string ProfilerTag = "GodRay2";
        private ProfilingSampler m_ProfilingSampler = new(ProfilerTag);
        
        private Material material;
        private GodRayVolume2 godRayVolume;
        ...
        public CustomRenderPass(Settings settings)
        {
            ...
            Shader shader = Shader.Find("URP/PostProcessing/GodRay2");
        ...
        public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            godRayVolume = stack.GetComponent<GodRayVolume2>();//从栈中获取到ColorTintVolume
            ...
            if (godRayVolume.CloudTex.value)
            {
                material.SetTexture("_CloudTex",godRayVolume.CloudTex.value);
                material.SetVector("_CloudTexTillingAndOffset",godRayVolume.CloudTexTillingAndOffset.value);
                material.SetVector("_CloudTexUVFlowSpeed",godRayVolume.CloudTexUVFlowSpeed.value);
            }
