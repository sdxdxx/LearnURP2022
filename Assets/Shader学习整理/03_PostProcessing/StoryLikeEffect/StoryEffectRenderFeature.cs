...
public class StoryEffectRenderFeature : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        private const string ProfilerTag = "StoryEffect";
        private ProfilingSampler m_ProfilingSampler = new(ProfilerTag);
        
        private Material material;
        private StoryEffectVolume volume;
        ...
        public CustomRenderPass(Settings settings)
        {
            ...
            Shader shader = Shader.Find("URP/PostProcessing/StoryEffect");
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            volume = stack.GetComponent<StoryEffectVolume>();//从栈中获取到ColorTintVolume
            if (!volume.EnbaleStoryEffect.value){return;}
            material.SetColor("_BaseColor", volume.ColorChange.value);//将材质颜色设置为volume中的值
            material.SetTexture("_PaperEffectTex",volume.PaperEffectTexture.value);
            material.SetVector("_PaperEffectTex_ST", volume.PaperEffectTillingAndOffset.value);
            material.SetFloat("_PaperEffectIntensity",volume.PaperEffectIntensity.value);
            material.SetFloat("_PaperMaskEdgeWidth",volume.PaperMaskEdgeWidth.value);
            material.SetFloat("_PaperMaskEdgeFlowSpeed",volume.PaperMaskEdgeFlowSpeed.value);
            material.SetTexture("_PaperMaskTex",volume.PaperMaskTexture.value);
            material.SetTexture("_PaperMaskNoise",volume.PaperMaskNoise.value);
            material.SetTexture("_VignetteMask",volume.VignetteMask.value);
            material.SetColor("_VignetteColor", volume.VignetteColor.value);
            material.SetFloat("_VignetteIntensity", volume.VignetteIntensity.value);
            material.SetFloat("_TestValue", volume.TestValue.value);
