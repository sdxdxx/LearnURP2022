...
public class PixelizeTestFeature : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        private PixelizeTestVolume pixelizeVolume;
        ...
        public CustomRenderPass(Settings settings)
        {
            ...
            Shader shader = Shader.Find("URP/PostProcessing/PixelizeTest");
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            pixelizeVolume = stack.GetComponent<PixelizeTestVolume>();//从栈中获取到Volume
