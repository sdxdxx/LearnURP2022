        ...
        pass
        {
           ...
           #include "Packages/com.unity.render-pipelines.core/ShaderLibrary/SpaceTransforms.hlsl"
            ...
            half4 frag (Varyings i) : SV_TARGET
            {
            	...
            	//float2 distorationUV = i.texcoord+distorationNoise/max(m_linearDepth,3)*_DistorationIntensity;
            	...
            	float depthFog = (_UnderWaterFogDensityMax-m_linearEyeDepth_distoration)/(_UnderWaterFogDensityMax-_UnderWaterFogDensityMin);
            	...
            	half3 mainCol = saturate(underWaterCol+CausiticsCol);
