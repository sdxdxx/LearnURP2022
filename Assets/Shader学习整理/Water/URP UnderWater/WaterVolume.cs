...
public class WaterVolume : VolumeComponent
{
    ...
    public BoolParameter EnableGlobalEffect_Editor = new BoolParameter(false, false);
    [Header("UnderWater")]
    ...
    public  ColorParameter UnderWaterFogColor = new ColorParameter(Color.white, true);
    public ClampedFloatParameter UnderWaterFogDensityMin = new ClampedFloatParameter(0, 0f, 500f, true);
    public ClampedFloatParameter UnderWaterFogDensityMax = new ClampedFloatParameter(1, 0f, 500f, true);
