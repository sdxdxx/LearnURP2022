    ...
    SubShader
    {
    	...
    	#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Core.hlsl"
            ...
            half4 frag (vertexOutput i) : SV_TARGET
            {
            	...
            	half4 refCol = SAMPLE_TEXTURE2D(_PlanarReflectionTexture,sampler_PlanarReflectionTexture,reflectUV);
                ...
                half3 blink = SAMPLE_TEXTURE2D(_PlanarReflectionTexture,sampler_PlanarReflectionTexture,screenPos+blinkUV * _NormalNoise);
                ...
                half3 FinalRGB = saturate(WaterFinalColor+shoreEdge+foam)+blink;
            	FinalRGB*=shadow;
    		...
    		half4 frag_Back (vertexOutput i) : SV_TARGET
            {
                ...
                half3 FinalRGB = saturate(waterFinalCol+foam+shoreEdge)+blink;
            	half4 result = half4(FinalRGB,1.0);
