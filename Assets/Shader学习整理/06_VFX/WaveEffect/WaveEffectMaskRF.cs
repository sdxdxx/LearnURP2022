...
public class WaveEffectMaskRF : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        private const string ProfilerTag = "WaveEffectMaskPass";
        ...
        private RTHandle cameraDepthRTHandle;// ★ 新增：保存相机深度句柄
        ...
        public void Setup(RTHandle cameraColor, RTHandle cameraDepth, RenderingData data)
        {
        ...
        public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            ConfigureTarget(maskRTHandle,cameraDepthRTHandle);
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            using (new ProfilingScope(cmd, m_ProfilingSampler))
            {
                ...
                DepthState depthState = new DepthState(writeEnabled: false, CompareFunction.LessEqual);//强制不写入深度
                ...
                cmd.SetGlobalTexture("_WaveEffectMask",maskRTHandle);
            }
        ...
        {
            maskRTHandle?.Release();//如果tempRTHandle没被释放的话，会被释放
    ...
    {
        m_ScriptablePass.Setup(renderer.cameraColorTargetHandle,renderer.cameraDepthTargetHandle,renderingData);//可以理解为传入GameView_RenderTarget的句柄和相机渲染数据（相机渲染数据用于创建TempRT）
    }
