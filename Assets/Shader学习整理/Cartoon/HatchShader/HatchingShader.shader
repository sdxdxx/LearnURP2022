    ...
    SubShader
    {
    	...
    	HLSLINCLUDE
            ...
            half4 frag (vertexOutput i) : SV_TARGET
            {
            	...
            	//Hatch
            	float2 hatchTexUV = i.uv *_HatchTex_ST.xy+_HatchTex_ST.zw;
            	half4 hatchTexture = SAMPLE_TEXTURE2D(_HatchTex,sampler_HatchTex,hatchTexUV);
            	half halfLambert = dot(nDir,mainLightDir)*0.5f+0.5f;
            	half realHatch = CalculateHatch(hatchTexture,1-halfLambert);
            	half3 mainColor = CalculatePBRResult(nDir,mainLightDir,vDir,albedo.rgb*realHatch,mainLightRadiance,smoothness,metallic,mainLightShadow);
