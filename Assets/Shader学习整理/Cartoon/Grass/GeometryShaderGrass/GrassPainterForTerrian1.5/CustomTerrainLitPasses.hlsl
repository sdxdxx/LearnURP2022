...
#endif
{
    ...
    half3 albedo = SAMPLE_TEXTURE2D(_DiffuseTex, sampler_MainTex, IN.uvMainAndLM.xy).rgb;
    half smoothness = SAMPLE_TEXTURE2D(_DiffuseTex, sampler_MainTex, IN.uvMainAndLM.xy).a;
