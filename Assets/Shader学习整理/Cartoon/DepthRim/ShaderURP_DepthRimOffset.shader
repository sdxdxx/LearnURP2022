    ...
    SubShader
    {
        ...
        pass
        {
             ...
             float4 frag(v2f i) : SV_Target
            {
                ...
                float depthTex = SAMPLE_DEPTH_TEXTURE(_CameraDepthTexture,sampler_PointClamp,scrPos+offset)+_OffsetZ;
                float depthTex0 = i.pos.z;//SAMPLE_DEPTH_TEXTURE(_CameraDepthTexture,sampler_PointClamp,i.scrPos.xy / i.scrPos.w);
